...
This project focuses on cleaning and preprocessing raw datasets using Python and Pandas. Tasks include handling missing values, removing duplicates, standardizing inconsistent formats, and preparing the data for further analysis.

2. Exploratory Data Analysis (Python)

Performed exploratory analysis to identify patterns, trends, and relationships within datasets. Visualizations such as histograms, boxplots, and scatterplots were created to better understand the underlying data.
